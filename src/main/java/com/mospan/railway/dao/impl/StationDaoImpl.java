...
import com.mospan.railway.dao.interfaces.StationDao;
...
public class StationDaoImpl implements StationDao {
    ...
    public Station findById(long id) {
        ...
        try (PreparedStatement st = con.prepareStatement("SELECT * FROM station WHERE id = ?");){
            st.setLong(1, id);
    ...
    public void insert(Station station) {
        con = cp.getConnection();
        try ( PreparedStatement st = con.prepareStatement("INSERT INTO station (name)" +
                " VALUES (?)");) {
    ...
    public void update(Station station) {
        con = cp.getConnection();
        try (PreparedStatement st = con.prepareStatement("UPDATE station SET name = ? WHERE id = ?")) {
            st.setString(1, station.getName());
    ...
    public void delete(Station station) {
        ...
        con = cp.getConnection();
        try (PreparedStatement st = con.prepareStatement("DELETE FROM station WHERE id = ?")) {
    ...
    public Collection<Station> findAll() {
        ...
        try ( PreparedStatement st = con.prepareStatement("SELECT * FROM station")) {
