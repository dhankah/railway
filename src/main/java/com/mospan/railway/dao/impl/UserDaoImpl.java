...
public class UserDaoImpl implements UserDao {
    ...
    public void insert(User user) {
        ...
        try (PreparedStatement st = con.prepareStatement("INSERT INTO user (login, password, role_id, detail_id)" +
                " VALUES (?, ?, ?, ?)")) {
    ...
    public void update(User user) {
        con = cp.getConnection();
        try (PreparedStatement st = con.prepareStatement("UPDATE user SET login = ?, password = ?, balance = ? WHERE id = ?")) {
    ...
    public User findByEmail(String email) {
        ...
        try (PreparedStatement st = con.prepareStatement("SELECT * FROM user WHERE detail_id = ?")) {
    ...
    public User findById(long id) {
        con = cp.getConnection();
        User user = new User();
        try (PreparedStatement st = con.prepareStatement("SELECT * FROM user WHERE id = ?")) {
            st.setLong(1, id);
